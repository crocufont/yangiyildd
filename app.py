...
async def register_user(
    ...
    if len(username) < 3:
        return templates.TemplateResponse("register.html", {
            "request": request,
            "error": "Foydalanuvchi nomi kamida 3 belgidan iborat bo'lishi kerak!",
            "success": None
        })
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Arial; }
        ...
        .btn { width: 100%; padding: 15px; margin: 20px 0 10px 0; border: none; border-radius: 10px; background: linear-gradient(135deg, #1a73e8, #4fc3f7); color: white; font-size: 18px; font-weight: 600; cursor: pointer; transition: opacity 0.3s; }
        ...
        .auth-link a { color: #4fc3f7; text-decoration: none; font-weight: 600; }
    </style>
</head>
<body>
    <div class="container">
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Arial; }
        ...
        .nav-btn { background: transparent; border: none; color: white; padding: 10px 15px; border-radius: 10px; cursor: pointer; display: flex; flex-direction: column; align-items: center; font-size: 12px; gap: 5px; }
        ...
        .countdown-box { background: linear-gradient(145deg, rgba(255,51,102,0.9), rgba(51,204,255,0.9)); padding: 15px 10px; border-radius: 10px; border: 2px solid rgba(255,255,255,0.3); transition: transform 0.3s; }
        ...
        <div id="leaderboard" class="page">
            ...
            <div class="card">
                <div id="leaderboard-list">
                    ...
                    <div class="leaderboard-item" style="{{ 'background: linear-gradient(90deg, rgba(255,51,102,0.2), rgba(51,204,255,0.2)); border-left: 4px solid #FFCC00;' if item.is_current else '' }}">
                        <div style="font-size: 20px; font-weight: 800; width: 40px; text-align: center;">{{ item.medal }}</div>
                        <div style="flex: 1; padding: 0 15px; font-size: 18px; font-weight: 600;">{{ item.username }} {% if item.is_current %}⭐{% endif %}</div>
                        <div style="font-size: 22px; font-weight: 800; color: #FFCC00;">{{ item.score }} 🎄</div>
                    </div>
                    {% endfor %}
                </div>
            </div>
...
if __name__ == "__main__":
    ...
    # Render uchun portni muhit o'zgaruvchisidan olish
